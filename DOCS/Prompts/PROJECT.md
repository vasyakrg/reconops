...
Investigator — сервис внутри hub'а, который ведёт диалог с Claude через Anthropic Messages API в режиме tool-use. Он:
...
- **LLM:** Anthropic Messages API, тонкий собственный клиент или Anthropic Go SDK
...
- Anthropic-клиент, tool-use loop.
